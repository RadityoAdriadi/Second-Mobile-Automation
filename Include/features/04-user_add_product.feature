...
Scenario Outline: Seller wants to add a product on Secondhand Application
  ...
  | T022    | Samsung Phone Case | 50500  | Bandung  | A strong case           | Preview                    | previewed successfully |
  | T023    | Black Leather Bag  | 150000 | Bandung  |                         | Terbitkan to trigger error | not added              |